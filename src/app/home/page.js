...
const SheetWrapper = ({ children, onBackdropClick, zIndex = 50 }) => (
  <div
    style={{
...
const ProfilePictureSheet = ({ onClose, onUploaded, accessToken }) => {
  ...
  const handleRetake = () => {
    ...
    setPreviewSrc(null); setSelectedFile(null); setErrorMsg(""); setStage("picker");
  };
    ...
    <SheetWrapper onBackdropClick={onClose}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "4px 16px 0" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <div style={{ width: 28, height: 28, borderRadius: "50%", background: "linear-gradient(135deg, #92400e, #d97706)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      {stage === "picker" && (
        <div style={{ padding: "20px 24px 36px" }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
            <div style={{ width: 88, height: 88, borderRadius: "50%", background: "linear-gradient(135deg, #fef3c7, #fde68a)", border: "3px dashed #fbbf24", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <button type="button" onClick={() => setStage("camera")}
          ...
          <button type="button" onClick={onClose}
            style={{ width: "100%", marginTop: 20, padding: "10px 0", background: "none", border: "none", fontSize: 13, color: "#9ca3af", cursor: "pointer" }}>
            Skip for now
          </button>
        </div>
      )}
      ...
      {stage === "preview" && previewSrc && (
        <div style={{ padding: "20px 24px 36px", textAlign: "center" }}>
          <p style={{ fontSize: 19, fontWeight: 700, color: "#78350f", marginBottom: 4 }}>Looks good?</p>
          <p style={{ fontSize: 13, color: "#a16207", marginBottom: 20 }}>Preview your photo before saving.</p>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 24 }}>
            <div style={{ width: 140, height: 140, borderRadius: "50%", overflow: "hidden", border: "4px solid #f59e0b", boxShadow: "0 0 0 4px #fef3c7" }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <button type="button" onClick={handleRetake}
              style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "12px 0", borderRadius: 12, background: "#f3f4f6", border: "1px solid #e5e7eb", fontSize: 14, fontWeight: 500, color: "#374151", cursor: "pointer" }}>
              <RotateCcw className="h-4 w-4" /> Retake
            </button>
            <button type="button" onClick={handleConfirm}
              style={{ flex: 2, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "12px 0", borderRadius: 12, background: "linear-gradient(135deg, #92400e, #d97706)", border: "none", fontSize: 14, fontWeight: 600, color: "#fff", cursor: "pointer" }}>
      ...
      {stage === "done" && (
        <div style={{ padding: "28px 24px 40px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, fontWeight: 600, color: "#15803d" }}>Photo saved!</p>
      ...
      {stage === "error" && (
        <div style={{ padding: "20px 24px 36px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15, fontWeight: 600, color: "#b91c1c", marginBottom: 6 }}>Upload failed</p>
          <p style={{ fontSize: 12, color: "#6b7280", marginBottom: 20 }}>{errorMsg}</p>
          <div style={{ display: "flex", gap: 10 }}>
            <button type="button" onClick={handleRetake}
              style={{ flex: 1, padding: "11px 0", borderRadius: 12, background: "#f3f4f6", border: "1px solid #e5e7eb", fontSize: 14, fontWeight: 500, color: "#374151", cursor: "pointer" }}>Try again</button>
            <button type="button" onClick={onClose}
              style={{ flex: 1, padding: "11px 0", borderRadius: 12, background: "none", border: "1px solid #e5e7eb", fontSize: 14, color: "#9ca3af", cursor: "pointer" }}>Cancel</button>
          </div>
        </div>
      )}
    </SheetWrapper>
  ...
  return (
    <SheetWrapper onBackdropClick={onClose}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "4px 16px 0" }}>
        <div style={{ width: 30 }} />
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <div style={{ width: 28, height: 28, borderRadius: "50%", background: "linear-gradient(135deg, #78350f, #b45309)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Sparkles className="h-3.5 w-3.5 text-white" />
          </div>
          <span style={{ fontSize: 12, fontWeight: 700, color: "#92400e", letterSpacing: "0.04em", textTransform: "uppercase" }}>Complete Profile</span>
        </div>
        <button type="button" onClick={onClose}
          style={{ background: "#f3f4f6", border: "none", borderRadius: "50%", width: 30, height: 30, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
          <X className="h-4 w-4 text-gray-500" />
      ...
      <div style={{ padding: "20px 24px 36px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
          <div style={{ position: "relative" }}>
            <div style={{ width: 80, height: 80, borderRadius: "50%", background: "linear-gradient(135deg, #fef3c7, #fde68a)", border: "3px solid #fbbf24", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <UserCheck className="h-9 w-9 text-amber-500" />
            </div>
            <div style={{ position: "absolute", inset: -4, borderRadius: "50%", border: "2px solid #fbbf24", opacity: 0.4, animation: "ping 1.8s cubic-bezier(0,0,0.2,1) infinite" }} />
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
          {missing.map(({ icon: Icon, label, sub }) => (
            <div key={label}
              style={{ display: "flex", alignItems: "center", gap: 14, padding: "13px 15px", borderRadius: 14, background: "linear-gradient(135deg, #fef9ee, #fef3c7)", border: "1px solid #fde68a" }}>
              <div style={{ width: 40, height: 40, borderRadius: 11, background: "rgba(245,158,11,0.15)", border: "1px solid rgba(245,158,11,0.3)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <Icon className="h-4.5 w-4.5 text-amber-600" style={{ width: 18, height: 18 }} />
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
                <p style={{ fontSize: 13, fontWeight: 600, color: "#78350f", margin: 0 }}>{label}</p>
                <p style={{ fontSize: 11.5, color: "#a16207", margin: "2px 0 0", lineHeight: 1.4 }}>{sub}</p>
              </div>
        ...
        <button type="button" onClick={onAction}
          style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "14px 0", borderRadius: 14, background: "linear-gradient(135deg, #92400e 0%, #b45309 50%, #d97706 100%)", border: "none", fontSize: 15, fontWeight: 700, color: "#fff", cursor: "pointer", boxShadow: "0 4px 16px rgba(146,64,14,0.30)", letterSpacing: "0.01em" }}>
          Update now <ChevronRight className="h-4 w-4" />
        </button>

        <button type="button" onClick={onClose}
          style={{ width: "100%", marginTop: 12, padding: "10px 0", background: "none", border: "none", fontSize: 13, color: "#9ca3af", cursor: "pointer" }}>
          Skip for now
        </button>
      </div>
    </SheetWrapper>
...
const TOUR_STEPS = [
  {
    id: "tour-avatar",
    title: "Your profile",
    body: "This is your avatar and name. Tap it anytime to view or edit your profile, and use the small camera icon to update your photo.",
  },
  {
    id: "tour-bell",
    title: "Notifications",
  ...
  },
  {
    ...
    body: "Your current wallet balance is shown here. Tap the eye icon to show or hide it, and use refresh to get the latest balance.",
  },
  {
    id: "tour-order",
  ...
  },
  {
    ...
    body: "Your most recent transactions appear here. Tap View All to see your full transaction history.",
  },
  {
    id: "tour-bottomnav",
...
const SpotlightTour = ({ onFinish }) => {
  ...
  if (rect) {
    ...
    if (spaceBelow > 180) {
      ...
      tooltipStyle.top = Math.max(rect.top - pad - 12 - 170, 12);
    }
  } else {
    tooltipStyle.top = "50%";
...
const MobileApp = () => {
  ...
  useEffect(() => {
    ...
    queryClient.invalidateQueries({ queryKey: ["transactions", accessToken] });
  }, [pathname, accessToken, queryClient]); // eslint-disable-line react-hooks/exhaustive-deps

  useEffect(() => {
    const handleVisibility = () => {
      if (document.visibilityState === "visible" && accessToken) {
        refetchProfile(); refetchTransactions(); fetchUnreadCount();
      }
    };
  ...
  const fetchUnreadCount = useCallback(async () => {
    if (!accessToken) return;
    try {
      const who = typeof window !== "undefined" && localStorage.getItem("who") === "client" ? "CLIENT" : "MERCHANT";
      const q = new URLSearchParams({ apiType: "notificationCountUnread", user_type: who, token: accessToken }).toString();
      const res = await fetch(`/api/user?${q}`, { method: "GET", headers: { "Content-Type": "application/json", Authorization: `Bearer ${accessToken}` } });
      if (!res.ok) return;
  ...
  useEffect(() => {
    if (typeof window !== "undefined") setHasInteractedWithSwitch(localStorage.getItem("hasInteractedWithSwitch") === "true");
  }, []);

  useEffect(() => { if (accessToken) fetchUnreadCount(); }, [accessToken, fetchUnreadCount]);

  useEffect(() => {
    if (token && accessToken) StoreFCMToken("/api/user", "POST", { accessToken, apiType: "updateToken", fcmToken: token });
  }, [token, accessToken]);

  useEffect(() => {
    if (accessToken) {
      const q = new URLSearchParams({ token: accessToken, apiType: "getMyOrders", type: "active", userType: "client" }).toString();
  ...
  const setupPulseTimer = () => {
    if (pulseTimerRef.current) clearTimeout(pulseTimerRef.current);
    if (!hasInteractedWithSwitch) { setShowPulseAnimation(true); setTimeout(() => setShowPulseAnimation(false), 3000); }
  ...
  useEffect(() => {
    ...
    queueTimerRef.current = setTimeout(() => {
      ...
      const needsInfo = missDOB || missPhone;

      setMissingFields({ dob: missDOB, phone: missPhone });
  ...
  // ── Sheet handlers ─────────────────────────────────────────────────
  const handleClosePicSheet = useCallback(() => {
    dequeue();
  }, [dequeue]);
  ...
  const moveToMerchant = useCallback(async () => {
    ...
    let settings = { ninVerificationEnabled: true, ninImageUploadEnabled: true, nameVerificationEnabled: true, faceVerificationEnabled: true };
    setIsMerchantNavLoading(true);
    try { settings = await fetchVerificationSettings(accessToken); }
    catch { /* use defaults */ }
  ...
  useEffect(() => {
    [
      ...
      "userProfile/ProfileInformation/updatePersonal",
  ...
  const handleManualRefresh = useCallback(() => { refetchProfile(); refetchTransactions(); }, [refetchProfile, refetchTransactions]);
    ...
    return (
      <div className="space-y-3">
        {recentTransactions.map((tx) => (
          <motion.div key={tx.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="bg-white p-4 rounded-lg shadow-sm">
            <div className="flex items-start justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full bg-amber-100 flex items-center justify-center text-amber-800 font-medium">{tx.initials}</div>
                <div>
              ...
              <div className="text-right flex flex-col items-end">
                ...
                <div className="mt-1"><PaymentStatusBadge status={tx.paymentStatus} /></div>
              </div>
            </div>
          </motion.div>
        ))}
        <div className="flex justify-center mt-2 pb-2">
          <button onClick={refetchTransactions} className="flex items-center gap-1.5 text-amber-500/70 text-xs py-1 px-3 rounded-full transition-colors hover:text-amber-600">
    ...
    <ProtectedRoute>
      <div className="flex flex-col h-screen bg-amber-50">
        ...
        <div className="px-4 py-3 bg-gradient-to-r from-amber-600 to-amber-500 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 min-w-0 flex-1 mr-2">
              <div id="tour-avatar" className="w-9 h-9 rounded-full bg-white/20 flex-shrink-0 flex items-center justify-center relative">
                <Image
            ...
            <div className="flex items-center space-x-3 flex-shrink-0">
              <div id="tour-bell" className="relative">
              ...
              <div id="tour-switch" className="relative" ref={dropdownRef}>
                <button
        ...
        <div className="flex-1 overflow-auto">
          <div id="tour-wallet">
            <WalletBalanceCard balance={walletBalance} isVisible={isBalanceVisible} onToggleVisibility={toggleBalanceVisibility} onRefresh={handleManualRefresh} isRefreshing={isProfileFetching} />
          </div>
          ...
          <div id="tour-transactions" className="p-4">
        ...
        <AnimatePresence mode="wait">
          {activeSheet === "profileInfo" && (
            <ProfileInfoSheet
              ...
              missingPhone={missingFields.phone}
